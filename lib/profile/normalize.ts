...
export const emptyProfile = (): Profile => ({
  ...
  targetRoles: [],
  preferredLocations: [],
  preferredLocationScope: undefined,
...
export function normalizeProfile(input?: unknown): Profile {
  ...
  return {
    ...
    preferredLocationScope: toString(data.preferredLocationScope) as Profile["preferredLocationScope"],
    preferredLocationCountry: toString(data.preferredLocationCountry),
    preferredLocationState: toString(data.preferredLocationState),
    preferredLocationCity: toString(data.preferredLocationCity),
